...
class App:
    def _enter_minigame(self):
        ...
        note_track_ratio = float(self.vars["note_track_ratio"])
        ...
        while self.macro_running:
            ...
            if fishing_profile == "dual":
                ...
                if any_bar_detected_this_frame2:
                    ...
                    bar_center2, left_x2, right_x2 = self._update_arrow_box_estimation(arrow_indicator_x, fish_width)
                ...
                if any_bar_detected_this_frame2 and not (left_x == None or right_x == None): # Bar Or Arrows Found
                    ...
                    bar_center2 = (left_x2 + bar_size2 / 2.0) + fish_left # Add Fish Left Here (float to preserve sub-pixel precision for velocity)
